...
.box {
display:block;
border: Thick dashed rgb(115, 144, 112);
width: 500px;
min-height: 300px;
font-size: 20px;
background-color:hsl(300, 25%, 46%);
}
.formelt{
color:rgba(204, 229, 13, 0.934);
text-align: center;
margin-top: 7px;
margin-bottom: 6px;
}
...
![alt text](<Screenshot 2025-04-29 213112.png>)

## HOMEPAGE:
![alt text](<Screenshot 2025-04-29 213021.png>)
